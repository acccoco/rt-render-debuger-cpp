...
// 注：数字表示精度级别，小数点后多少位
// =========================================================
const float epsilon_7 = std::numeric_limits<float>::epsilon();
const float epsilon_6 = epsilon_7 * 10.f;
const float epsilon_5 = epsilon_7 * 100.f;
const float epsilon_4 = epsilon_7 * 1000.f;
const float epsilon_3 = epsilon_7 * 10000.f;
const float epsilon_2 = epsilon_7 * 100000.f;
const float epsilon_1 = epsilon_7 * 1000000.f;
const float epsilon_38 = std::numeric_limits<float>::min();
